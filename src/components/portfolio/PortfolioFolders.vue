...
.pf-item:focus-visible{box-shadow:0 0 0 3px rgba(90,70,255,.35);border-radius:12px}
.pf-item:hover{transform:translateY(-6px)}
.icon-wrap{width:95px;aspect-ratio:1/1;display:flex;align-items:center;justify-content:center;position:relative}
.icon-wrap img{width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 4px 10px rgba(0,0,0,.15))}
.label{text-align:center;font-size:.9rem;letter-spacing:.5px;font-weight:500;text-transform:none}
@media (max-width:640px){.pf-grid{gap:1.6rem}.icon-wrap{width:84px}.pf-title{font-size:clamp(1.8rem,7vw,2.4rem)}}
</style>
